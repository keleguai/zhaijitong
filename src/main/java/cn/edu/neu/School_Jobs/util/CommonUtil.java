...
public class CommonUtil {
    ...
    public static JSONObject pageInfo(int pageNum, int pageSize, int count, List lists) {
        ...
        jsonObject.put("lastPage", Math.ceil((double) count / pageSize));
        return jsonObject;
    }
